  ...
  .action(
    async (
      ...
      try {
        ...
        try {
          const url =
            `${BUILD_CONFIG.api.endpoint}/v1/verification-keys/${targetKey.key_id}/revoke`;
          ...
          warning(
            `Failed to delete keys from dashboard; please manually delete them at ${BUILD_CONFIG.api.dashboardUrl}/dashboard/verification-keys`,
          );
        }
